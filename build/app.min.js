...
}]),function(a){a(["jquery"],function(a){return function(){function b(a,b,c){return o({type:v.error,iconClass:p().iconClasses.error,message:a,optionsOverride:c,title:b})}function c(b,c){return b||(b=p()),r=a("#"+b.containerId),r.length?r:(c&&(r=l(b)),r)}function d(a,b,c){return o({type:v.info,iconClass:p().iconClasses.info,message:a,optionsOverride:c,title:b})}function e(a){s=a}function f(a,b,c){return o({type:v.success,iconClass:p().iconClasses.success,message:a,optionsOverride:c,title:b})}function g(a,b,c){return o({type:v.warning,iconClass:p().iconClasses.warning,message:a,optionsOverride:c,title:b})}function h(a,b){var d=p();r||c(d),k(a,d,b)||j(d)}function i(b){var d=p();return r||c(d),b&&0===a(":focus",b).length?void q(b):void(r.children().length&&r.remove())}function j(b){for(var c=r.children(),d=c.length-1;d>=0;d--)k(a(c[d]),b)}function k(b,c,d){var e=d&&d.force?d.force:!1;return b&&(e||0===a(":focus",b).length)?(b[c.hideMethod]({duration:c.hideDuration,easing:c.hideEasing,complete:function(){q(b)}}),!0):!1}function l(b){return r=a("<div/>").attr("id",b.containerId).addClass(b.positionClass).attr("aria-live","polite").attr("role","alert"),r.appendTo(a(b.target)),r}function m(){return{tapToDismiss:!0,toastClass:"toast",containerId:"toast-container",debug:!1,showMethod:"fadeIn",showDuration:300,showEasing:"swing",onShown:void 0,hideMethod:"fadeOut",hideDuration:1e3,hideEasing:"swing",onHidden:void 0,extendedTimeOut:1e3,iconClasses:{error:"toast-error",info:"toast-info",success:"toast-success",warning:"toast-warning"},iconClass:"toast-info",positionClass:"toast-top-right",timeOut:5e3,titleClass:"toast-title",messageClass:"toast-message",target:"body",closeHtml:'<button type="button">&times;</button>',newestOnTop:!0,preventDuplicates:!1,progressBar:!1}}function n(a){s&&s(a)}function o(b){function d(){g(),i(),j(),k(),l(),h()}function e(){A.hover(v,s),!x.onclick&&x.tapToDismiss&&A.click(o),x.closeButton&&E&&E.click(function(a){a.stopPropagation?a.stopPropagation():void 0!==a.cancelBubble&&a.cancelBubble!==!0&&(a.cancelBubble=!0),o(!0)}),x.onclick&&A.click(function(){x.onclick(),o()})}function f(){A.hide(),A[x.showMethod]({duration:x.showDuration,easing:x.showEasing,complete:x.onShown}),x.timeOut>0&&(z=setTimeout(o,x.timeOut),F.maxHideTime=parseFloat(x.timeOut),F.hideEta=(new Date).getTime()+F.maxHideTime,x.progressBar&&(F.intervalId=setInterval(w,10)))}function g(){b.iconClass&&A.addClass(x.toastClass).addClass(y)}function h(){x.newestOnTop?r.prepend(A):r.append(A)}function i(){b.title&&(B.append(b.title).addClass(x.titleClass),A.append(B))}function j(){b.message&&(C.append(b.message).addClass(x.messageClass),A.append(C))}function k(){x.closeButton&&(E.addClass("toast-close-button").attr("role","button"),A.prepend(E))}function l(){x.progressBar&&(D.addClass("toast-progress"),A.prepend(D))}function m(a,b){if(a.preventDuplicates){if(b.message===t)return!0;t=b.message}return!1}function o(b){return!a(":focus",A).length||b?(clearTimeout(F.intervalId),A[x.hideMethod]({duration:x.hideDuration,easing:x.hideEasing,complete:function(){q(A),x.onHidden&&"hidden"!==G.state&&x.onHidden(),G.state="hidden",G.endTime=new Date,n(G)}})):void 0}function s(){(x.timeOut>0||x.extendedTimeOut>0)&&(z=setTimeout(o,x.extendedTimeOut),F.maxHideTime=parseFloat(x.extendedTimeOut),F.hideEta=(new Date).getTime()+F.maxHideTime)}function v(){clearTimeout(z),F.hideEta=0,A.stop(!0,!0)[x.showMethod]({duration:x.showDuration,easing:x.showEasing})}function w(){var a=(F.hideEta-(new Date).getTime())/F.maxHideTime*100;D.width(a+"%")}var x=p(),y=b.iconClass||x.iconClass;if("undefined"!=typeof b.optionsOverride&&(x=a.extend(x,b.optionsOverride),y=b.optionsOverride.iconClass||y),!m(x,b)){u++,r=c(x,!0);var z=null,A=a("<div/>"),B=a("<div/>"),C=a("<div/>"),D=a("<div/>"),E=a(x.closeHtml),F={intervalId:null,hideEta:null,maxHideTime:null},G={toastId:u,state:"visible",startTime:new Date,options:x,map:b};return d(),f(),e(),n(G),x.debug&&console&&console.log(G),A}}function p(){return a.extend({},m(),w.options)}function q(a){r||(r=c()),a.is(":visible")||(a.remove(),a=null,0===r.children().length&&(r.remove(),t=void 0))}var r,s,t,u=0,v={error:"error",info:"info",success:"success",warning:"warning"},w={clear:h,remove:i,error:b,getContainer:c,info:d,options:{},subscribe:e,success:f,version:"2.1.1",warning:g};return w}()})}("function"==typeof define&&define.amd?define:function(a,b){"undefined"!=typeof module&&module.exports?module.exports=b(require("jquery")):window.toastr=b(window.jQuery)}),function(){angular.module("achilles",["ngResource","ngSanitize","ui.bootstrap","rt.select2","textAngular"])}(),function(){function a(a){a.interceptors.push("SpinnerHttpInterceptor")}function b(a,b){var c={response:function(a){return a.config.spinner&&b(function(){$("#loading-overlay").css("display","none")},150),a},responseError:function(c){return c.config.spinner&&b(function(){$("#loading-overlay").css("display","none")},150),a.reject(c)},request:function(a){return"GET"==a.method&&a.spinner&&$("#loading-overlay").css("display","block"),a}};return c}angular.module("achilles").config(a).factory("SpinnerHttpInterceptor",b),a.$inject=["$httpProvider"],b.$inject=["$q","$timeout"]}(),function(){function a(a){a.decorator("taOptions",["taRegisterTool","$delegate",function(a,b){return a("colorRed",{iconclass:"fa fa-square red-text",action:function(){this.$editor().wrapSelection("forecolor","red")}}),a("colorBlue",{iconclass:"fa fa-square blue-text",action:function(){this.$editor().wrapSelection("forecolor","blue")}}),a("colorOrange",{iconclass:"fa fa-square orange-text",action:function(){this.$editor().wrapSelection("forecolor","orange")}}),a("colorGreen",{iconclass:"fa fa-square green-text",action:function(){this.$editor().wrapSelection("forecolor","green")}}),a("colorBlack",{iconclass:"fa fa-square",action:function(){this.$editor().wrapSelection("forecolor","black")}}),a("colorGrey",{iconclass:"fa fa-square grey-text",action:function(){this.$editor().wrapSelection("forecolor","lightgrey")}}),b.toolbar=[["bold","italics","underline","colorRed","colorOrange","colorGreen","colorBlue","colorBlack","colorGrey","ul","ol","redo","undo","clear"]],b}])}angular.module("achilles").config(a),a.$inject=["$provide"]}(),function(){function a(a,b,c,d){function e(){a.get(b.treatmentList(achillesConfig.patient),{spinner:!0}).then(function(a){g.treatments=a.data})}function f(){c.get(achillesConfig.process).then(function(a){g.user=a})}var g=this;g.baseUrl=b.baseUrl(),g.entries=[],g.loadEntries=e,g.process=achillesConfig.process,g.patient=achillesConfig.patient,g.reverse=!1,g.marginOptions=[{"class":"large-margins",label:"Grosse Abstände"},{"class":"small-margins",label:"Kleine Abstände"}],g.fontSizes=[{"class":"large-fonts",label:"Gross"},{"class":"medium-fonts",label:"Mittel"},{"class":"small-fonts",label:"Klein"}],g.checkEditPermission=d.checkEditPermission,g.loadEntries(),f()}angular.module("achilles").controller("MainController",a),a.$inject=["$http","urls","User","TreatmentPermission"]}(),function(){function a(a,b){a.ok=function(){b.close()},a.cancel=function(){b.dismiss("canceled")}}function b(a,b){a.presets=[{id:1,name:"SOAP"},{id:2,name:"Gynäkologische Untersuchung"},{id:3,name:"Vermicelles"},{id:4,name:"Schoggischuum"}],a.close=function(a){b.close(a)}}angular.module("achilles").controller("DeleteModalController",a).controller("PresetModalController",b),a.$inject=["$scope","$modalInstance"],b.$inject=["$scope","$modalInstance"]}(),function(){function a(a){function b(b,c,d){console.log(document.activeElement);var e=c.find("textarea");a(function(){console.log(document.activeElement),e.focus(),console.log("trying"),console.log(document.activeElement)},5e3),c.find("a").on("click",function(){console.log("focus"),e.select2("open")})}var c={link:b};return c}angular.module("achilles").directive("modalSelect2",a),a.$inject=["$timeout"]}(),function(){function a(a){function b(b,c,d,e){c.on("click",function(){e.isOpen()&&a(function(){c.find("li a").eq(0).focus()},150)}),c.on("keydown","li a",function(a){if(40==a.which){a.preventDefault();var b=$(this).parent().nextAll(":visible:not(.divider)").first().find("a"),c=$(this).parent().siblings().first().find("a");b.length?b.focus():c.focus()}if(38==a.which){a.preventDefault();var d=$(this).parent().prevAll(":visible:not(.divider)").first().find("a"),e=$(this).parent().siblings().last().find("a");d.length?d.focus():e.focus()}})}var c={require:"dropdown",link:b};return c}angular.module("achilles").directive("toggleFocus",a),a.$inject=["$timeout"]}(),function(){function a(a,c,d,e,f,g,h){function i(a){return"true"==a?l.editable:l.readonly}function j(b,j,l,m){function n(a){j.html(i(a)).show(),e(j.contents())(b)}function o(a){angular.element(this).hasClass("ng-dirty")&&!b.row.locked&&v(b.parent,b.row),d(function(){b.entry.focused=!1}),d.cancel(k)}function p(a){if(b.row.locked&&u(a))a.preventDefault();else if(a.ctrlKey&&a.shiftKey&&8==a.which){var c=j.parents(".row").prev().find("textarea:not(:disabled)"),e=j.parents(".row").next().find("textarea:not(:disabled)"),f=j.parents("treatment-entry").prev().find("textarea:not(:disabled)"),i=j.parents("treatment-entry").next().find("textarea:not(:disabled)");d(function(){c.length?c.eq(0).focus():f.length?f.eq(0).focus():e.length?e.eq(0).focus():i.eq(0).focus()},150),w.removeRow(b.row)}else a.ctrlKey&&13==a.which?(v(b.parent,b.row),h.addEntry(b.treatment.id,b.entry.type,b.treatment.entries)):!b.row.hasOwnLock&&u(a)&&g.lock(b.row)}function q(a){f.setCurrentFocus(b.row),b.warning&&!b.warning.displayed&&(toastr.warning(b.warning.message),b.warning.displayed=!0),k=d(function(){g.check(b.row)},450),d(function(){b.entry.focused=!0})}function r(a){b.readonly()&&b.warning&&!b.warning.displayed&&(toastr.error(b.warning.message),b.warning.displayed=!0)}function s(a){if(!a.length)return null;var b=a[0];return t(b)}function t(a){for(var b=0;b<a.childNodes.length;b++){var c=a.childNodes[b];if(3==c.nodeType){if(c.nodeValue.indexOf("*")>=0)return c}else{var d=t(c);if(d)return d}}return null}function u(a){return!(9==a.which||a.which>=37&&a.which<=40||a.ctrlKey&&65==a.which||a.ctrlKey&&67==a.which)}function v(b,d){a.post(c.treatmentEntryRow("put"),d).then(function(a){for(var c=a.data,d=b.rows,e=0;e<d.length;e++)if(d[e].id==c.id){d[e]=c;break}c.locked=!1,c.hasOwnLock=!1})}var w=(m[0],m[1]);b.columnClass="col-xs-"+l.width,j.on("blur",".ta-bind",o),j.on("keydown",".ta-bind",p),j.on("focus",".ta-bind",q),j.on("click",".ta-bind",r),l.$observe("editable",n),n(l.editable),b.$watch(f.getNewFocus,function(a){if(a&&b.row.id==a.id){var c=j.find(".ta-bind:not(.ta-readonly)");c.eq(0).focus();var d=s(c);if(d){var e=document.createRange(),f=d.nodeValue.indexOf("*");e.setStart(d,f),e.setEnd(d,f+1);var g=window.getSelection();g.removeAllRanges(),g.addRange(e)}}})}var k,l={editable:'<div ng-class="columnClass"><div class="form-group"><div ng-model="content" ta-disabled="readonly()" text-angular ta-target-toolbars="toolbar-{{treatment.id}}-{{type.id}}"></div></div></div>',readonly:'<div ng-class="columnClass"><p ng-bind-html="readonlyContent"></p></div>'},m={restrict:"E",scope:{width:"@",content:"=",readonly:"&",parent:"=",row:"=",uniqueId:"@",treatment:"=",warning:"=",type:"=",entry:"="},require:["^treatment","^treatmentEntry"],controller:b,link:j};return m}function b(a,b){a.readonlyContent=b.trustAsHtml(a.content)}angular.module("achilles").directive("treatmentColumn",a),a.$inject=["$http","urls","$timeout","$compile","CurrentFocus","Locking","Treatment"],b.$inject=["$scope","$sce"]}(),function(){function a(){function a(a,b,c,d){a.removeEntry=d.removeEntry}var c={scope:{entry:"=",editable:"@",treatment:"=",permissionToEdit:"&",warning:"="},restrict:"E",templateUrl:"../js/templates/treatment-entry.tpl.html",require:"^treatment",controller:b,link:a};return c}function b(a,b,c){function d(b){a.entry.focused=b}function e(){a.entryform.$setPristine()}function f(d){var e=a.entry.rows;b.post(c.treatmentEntryRow("delete")+d.id).then(function(){for(var b=0;b<e.length;b++)if(e[b].id==d.id){e.splice(b,1);break}0===e.length&&a.removeEntry(a.entry)})}var g=this;g.setEntryFocus=d,g.makePristine=e,g.removeRow=f}angular.module("achilles").directive("treatmentEntry",a),b.$inject=["$scope","$http","urls"]}(),function(){function a(a){function b(b,c){function d(){a(function(){var a=c.find(".ta-bind:not(.ta-readonly)").eq(0);a.focus()},150)}b.$watch("row.changed",function(a){a&&d()}),b.row["new"]===!0&&d()}var c={link:b};return c}angular.module("achilles").directive("treatmentRow",a),a.$inject=["$timeout"]}(),function(){function a(){var a={controller:b,controllerAs:"dc"};return a}function b(a,b,c,d,e){function f(a){var c=a.length?b("orderBy")(a,["-date","id"])[0]:{id:0};d.addTreatment(c,!0,!0,a)}function g(a){var c,d,f,g,h=[];c=e.getCurrentFocus(),a.forEach(function(a){if("true"===a.editable||a.editable===!0){var c=b("orderBy")(a.entries,"type.name");c.forEach(function(a){a.rows.forEach(function(a){h.push(a)})})}}),c?(console.log("here"),f=h.slice(h.indexOf(c)+1)):f=h,g=b("filter")(f,{$:"*"}),0===g.length&&(g=b("filter")(h,{$:"*"})),d=g.shift(),d&&e.setNewFocus(d)}function h(b){a.get(c.biometricReport(b))}function i(b){a.get(c.laboratoryReport(b))}function j(b,d){var e=[];d.forEach(function(a){console.log(a);var b={id:a.id,rows:[]};a.entries.forEach(function(a){a.rows.forEach(function(a){b.rows.push(a.id)})}),e.push(b)}),a.post(c.treatmentReport(b),e)}function k(b,d,e){a.post(c.executeGDT(b,d,e)).then(function(){console.log("that worked")})["catch"](function(){console.log("that didn't")})}function l(){a.get(c.gdtList()).then(function(a){m.gdtDevices=a.data})}var m=this;m.addTreatment=f,m.asteriskSearch=g,m.openBiometricReport=h,m.openLaboratoryReport=i,m.openTreatmentReport=j,m.executeGDT=k,l()}angular.module("achilles").directive("treatmentToolbar",a),b.$inject=["$http","$filter","urls","Treatment","CurrentFocus"]}(),function(){function a(a){function c(b,c,d,e){var f;b.treatment.editable=b.editable,c.on("keydown",function(a){120==a.which&&c.find(".type-select input").select2("open"),121==a.which&&e.testModal()}),c.on("focusin",function(){a(function(){b.treatment.focused=!0,b.editable=!0,b.treatment.editable=!0}),a.cancel(f)}),c.on("focusout",function(){f=a(function(){b.treatment.focused=!1},300)}),c.on("select2-open",function(){console.log("opened"),b.select2Open=!0}),c.on("select2-blur",function(){console.log("blurred"),b.select2Open=!1})}var d={scope:{treatment:"=",treatments:"=treatmentlist",editable:"@",user:"="},restrict:"E",controller:b,controllerAs:"dc",templateUrl:"../js/templates/treatment.tpl.html",link:c};return d}function b(a,b,c,d,e,f,g,h,i,j,k,l,m){function n(a){a&&!s.documents&&j.list(t).then(function(a){s.documents=a},function(a){console.error(a.statusText),s.documents=[{id:1,name:"War & Peace"},{id:2,name:"Skin Game"}]})}function o(a){a&&!s.laboratoryReports&&k.list(t).then(function(a){s.laboratoryReports=a},function(){})}function p(a){a&&!s.biometrics&&l.list(t).then(function(a){s.biometrics=a},function(){})}function q(a){a&&!s.disabilityCertificates&&m.list(t).then(function(a){s.disabilityCertificates=a},function(){})}function r(a){var c=a.invoiceCase;a.invoiceCase={id:0,name:""},b.post(d.treatment("put"),a).then(function(b){a.invoiceCase=b.data.invoiceCase},function(){a.invoiceCase=c})}var s=this,t=a.treatment.id;s.newEntry={type:null},e.all().then(function(a){s.types=a}),i.all().then(function(a){s.subjects=a}),s.loadDocuments=n,s.loadLaboratoryReports=o,s.loadBiometrics=p,s.loadDisability=q,s.addEntry=h.addEntry,s.baseUrl=d.baseUrl(),s.addTreatment=h.addTreatment,s.copyTreatment=h.copyTreatment,s.deleteTreatment=h.deleteTreatment,s.changeStatus=h.changeStatus,s.changeSubject=h.changeSubject,s.removeCase=r,s.warning={},s.permissionToEdit=!1,g.get().then(function(b){s.warning=f.shouldBeWarned(b,a.treatment),s.permissionToEdit=f.checkEditPermission(b,a.treatment)}),s.removeEntry=function(b){for(var c=a.treatment.entries,d=0;d<c.length;d++)if(b.type.id==c[d].type.id){c.splice(d,1);break}},s.testModal=function(){c.open({templateUrl:"../js/templates/preset-modal.tpl.html",controller:"PresetModalController",controllerAs:"mc",size:"lg"})}}angular.module("achilles").directive("treatment",a),a.$inject=["$timeout"],b.$inject=["$scope","$http","$modal","urls","EntryType","TreatmentPermission","User","Treatment","Subject","Document","LaboratoryReport","Biometric","DisabilityCertificate"]}();var something=0;toastr.options={positionClass:"toast-top-full-width"},function(){function a(a,b){function c(c){return a.get(b.biometricList(c),{spinner:!0}).then(function(a){return a.data})}var d={list:c};return d}angular.module("achilles").service("Biometric",a),a.$inject=["$http","urls"]}(),function(){function a(){function a(){return e}function b(){return f}function c(a){e=a}function d(a){f=a}var e,f,g={setCurrentFocus:c,getCurrentFocus:a,setNewFocus:d,getNewFocus:b};return g}angular.module("achilles").factory("CurrentFocus",a)}(),function(){function a(a,b){function c(c){return a.get(b.disabilityList(c),{spinner:!0}).then(function(a){return a.data})}var d={list:c};return d}angular.module("achilles").service("DisabilityCertificate",a),a.$inject=["$http","urls"]}(),function(){function a(a,b){function c(c){return a.get(b.documentList(c),{spinner:!0}).then(function(a){return a.data})}var d={list:c};return d}angular.module("achilles").service("Document",a),a.$inject=["$http","urls"]}(),function(){function a(a,b,c){function d(){var d=b.defer();return f.length?d.resolve(f):g?h.push(d):(g=!0,a.get(c.treatmentEntryTypeList()).then(function(a){f=a.data;for(var b=0;b<f.length;b++)f[b].toString=function(){return this.id};g=!1,d.resolve(f),h.forEach(function(a){a.resolve(f)})})),d.promise}var e={all:d},f=[],g=!1,h=[];return e}angular.module("achilles").factory("EntryType",a),a.$inject=["$http","$q","urls"]}(),function(){function a(a,b){function c(c){return a.get(b.laboratoryList(c),{spinner:!0}).then(function(a){return a.data})}var d={list:c};return d}angular.module("achilles").service("LaboratoryReport",a),a.$inject=["$http","urls"]}(),function(){function a(a,b){function c(c){a.get(b.lock(c,achillesConfig.process)).then(function(a){var b=a.data;b.lock?(c.locked=!0,c.lockedBy=b.lockedBy):(c.locked=!1,b.row.lastChange>c.lastChange?(c.columns=b.row.columns,c["new"]=b.row["new"],c.changed=!0,c.lastChange=b.row.lastChange):0===b.row.id&&(c.id=0,c.deleted=!0))})}function d(c){var d={method:"POST",url:b.lock(c,achillesConfig.process,"put"),headers:{"Content-Type":"text/plain"}};a(d).then(function(a){204==a.status?c.hasOwnLock=!0:(c.lock=!0,c.lockedBy=a.data.lockedBy)})}var e={check:c,lock:d};return e}angular.module("achilles").factory("Locking",a),a.$inject=["$http","urls"]}(),function(){function a(a,b,c){function d(){var d=b.defer();return f.length?d.resolve(f):g?h.push(d):(g=!0,a.get(c.treatmentSubject()).then(function(a){f=a.data,g=!1,d.resolve(f),h.forEach(function(a){a.resolve(f)})})),d.promise}var e={all:d},f=[],g=!1,h=[];return e}angular.module("achilles").service("Subject",a),a.$inject=["$http","$q","urls"]}(),function(){function a(){function a(a,b){return("warn"==a.permission.modifyRange.mode||c-24*a.permission.modifyRange.pastDays*60*60*1e3<b.date&&c+24*a.permission.modifyRange.futureDays*60*60*1e3>b.date)&&(!b.isMandatorTreatment&&!a.isMandator||a.permission.editMandatorEntry&&(!a.isMandator||b.mandator==a.mandator.id))}function b(b,d){return a(b,d)?"warn"==b.permission.modifyRange.mode&&(c-24*b.permission.modifyRange.pastDays*60*60*1e3>d.date||c+24*b.permission.modifyRange.futureDays*60*60*1e3<d.date)?{displayed:!1,message:"Behandlungseintrag liegt ausserhalb des änderbaren Bereichs"}:!1:b.permission.editMandatorEntry?d.mandator!=b.mandator.id?{displayed:!1,message:"Nur der verantwortliche Mandant darf den Text ändern"}:void 0:{displayed:!1,message:"Sie verfügen nicht über die notwendigen Benutzerrechte um diese Aktion auszuführen"}}var c=Date.now(),d={checkEditPermission:a,shouldBeWarned:b};return d}angular.module("achilles").factory("TreatmentPermission",a)}(),function(){function a(a,b,c){function d(b,d,e){a.post(c.treatmentEntry(),{treatmentId:b,type:d}).then(function(a){for(var b=a.data,c=!1,d=0;d<e.length;d++)if(b.type.id==e[d].type.id){console.log("already in list"),e[d]=b,c=!0;break}c||e.push(b)})}function e(b,d,e,f){new Date;a.post(c.treatment(),{patient:achillesConfig.patient,process:achillesConfig.process,treatment:{id:b.id,isMandatorTreatment:d,isMainTreatment:e}}).then(function(a){f.push(a.data)})}function f(b,d){a.post(c.copyTreatment(),{process:achillesConfig.process,treatment:{id:b.id}}).then(function(a){d.push(a.data)})}function g(d,e){var f=b.open({templateUrl:"../js/templates/delete-modal.tpl.html",controller:"DeleteModalController",controllerAs:"mc",size:"sm"});f.result.then(function(){a.post(c.treatment("delete"),d).then(function(a){for(var b=0;b<e.length;b++)if(e[b].id==d.id){e.splice(b,1);break}})})}function h(b){b.closed=!b.closed,a.post(c.treatment("put"),b).then(function(a){b.closed=a.data.closed,console.log("treatment status changed")},function(a){b.closed=!b.closed})}function i(b,d){var e=b.subject;b.subject=d,a.post(c.treatment("put"),b).then(function(a){b.subject=a.data.subject},function(a){b.subject=e})}var j={addTreatment:e,copyTreatment:f,deleteTreatment:g,changeStatus:h,changeSubject:i,addEntry:d};return j}angular.module("achilles").factory("Treatment",a),a.$inject=["$http","$modal","urls"]}(),function(){function a(){function a(){return v+w+":"+x+"/"}function b(b){return a()+y.caseList.replace(/:([a-z]\w*)/gi,b)+"/"}function c(b,c,d){var e="";return d&&(e=d+"/"),a()+e+y.lock.replace(/:row/,b.id).replace(/:process/,c)+"/"}function d(b,c,d){return a()+(d?y.executeGDTTest:y.executeGDT).replace(/:device/,b.id).replace(/:patient/,c).replace(/:test/,d?d.code:"")+"/"}function e(b){return a()+y.treatmentlist.replace(/:([a-z]\w*)/gi,b)+"/"}function f(){return a()+y.treatmententrytype+"/"}function g(){return a()+y.treatmententry+"/"}function h(b){var c="";return b&&(c=b+"/"),a()+c+y.treatmententryrow+"/"}function i(){return a()+y.treatmentsubject+"/"}function j(b){var c="";return b&&(c=b+"/"),a()+c+y.treatment+"/"}function k(){return a()+y.copyTreatment+"/"}function l(b){return a()+y.documentList.replace(/:([a-z]\w*)/gi,b)+"/"}function m(){return a()+y.gdtList+"/"}function n(b){return a()+y.laboratoryList.replace(/:([a-z]\w*)/gi,b)+"/"}function o(b){return a()+y.biometricList.replace(/:([a-z]\w*)/gi,b)+"/"}function p(b){return a()+y.disabilityList.replace(/:([a-z]\w*)/gi,b)+"/"}function q(b){return a()+y.removeCase.replace(/:treatment/gi,b.id).replace(/:case/gi,b.invoiceCase.id)+"/"}function r(b){return a()+y.biometricReport.replace(/:process/gi,b)+"/"}function s(b){return a()+y.laboratoryReport.replace(/:process/gi,b)+"/"}function t(b){return a()+y.treatmentReport.replace(/:process/gi,b)+"/"}function u(b){return a()+y.user.replace(/:process/,b)+"/"}var v="http://",w="192.168.1.107",x="36611",y={biometricList:"treatment/:treatment/biometriclist",biometricReport:"biometricreport/process/:process",caseList:"treatment/:treatment/caselist",copyTreatment:"treatment/copy",disabilityList:"treatment/:treatment/disabilitylist",documentList:"treatment/:treatment/documentlist",laboratoryList:"treatment/:treatment/laboratorylist",laboratoryReport:"laboratoryreport/process/:process",removeCase:"treatment/:treatment/case/:case",treatmententry:"treatmententry",treatmententryrow:"treatmententryrow",treatmententrytype:"treatmententrytype",treatmentlist:"patient/:patient/treatmentlist",treatmentReport:"treatmentreport/process/:process",treatmentsubject:"treatmentsubject",treatment:"treatment",gdtList:"gdt/list",executeGDT:"gdt/:device/patient/:patient",executeGDTTest:"gdt/:device/patient/:patient/code/:test",lock:"treatmententryrow/lock/:row/process/:process",user:"user/process/:process"},z={baseUrl:a,biometricList:o,biometricReport:r,caseList:b,copyTreatment:k,disabilityList:p,documentList:l,laboratoryList:n,laboratoryReport:s,removeCase:q,treatmentEntryTypeList:f,treatmentEntry:g,treatmentEntryRow:h,treatmentList:e,treatmentSubject:i,treatment:j,treatmentReport:t,gdtList:m,executeGDT:d,lock:c,user:u};return z}angular.module("achilles").factory("urls",a)}(),function(){function a(a,b,c){function d(){var d=b.defer();return e?d.resolve(e):f?g.push(d):(f=!0,a.get(c.user(h)).then(function(a){e=a.data,f=!1,d.resolve(e),g.forEach(function(a){a.resolve(e)})})),d.promise}var e,f=!1,g=[],h=achillesConfig.process,i={get:d};return i}angular.module("achilles").factory("User",a),a.$inject=["$http","$q","urls"]}();
